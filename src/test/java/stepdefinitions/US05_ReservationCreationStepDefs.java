...
public class US05_ReservationCreationStepDefs extends Hooks
{
    ...
    public void user_enters_valid_datas_at_Create_Hotelroomreservation() throws InterruptedException //thread.sleep(); ten dolayı exception var
    {
        ...
        us05_reservationCreation.email.sendKeys(ConfigurationReader.getProperty("email"));
    ...
    public void list_OF_RESERVATION_must_be_accessible()
    {
        Driver.getDriver().navigate().to(ConfigurationReader.getProperty("fhcReservationTable"));
        us05_reservationCreation.emailSearchBox.sendKeys(ConfigurationReader.getProperty("email"));
        us05_reservationCreation.searchButton.click();
        Assert.assertEquals(us05_reservationCreation.registeredEmail.getText(),ConfigurationReader.getProperty("email"));
